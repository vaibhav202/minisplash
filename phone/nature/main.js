...
const miniSplash = 'https://api.unsplash.com/search/photos/?per_page=50&order_by=latest&orientation=portrait&query=nature+forest+mountains+rivers&client_id=jNPKpYi80xqW7F7Ot37Mqsaft-NsbggphFw0WRAyw-E';
fetch(miniSplash)
.then(response =>{
    if(response.ok){
